...
\documentclass[11pt]{article}
    ...
    \def\lt{<}
    % Document parameters
    \title{statistik\_aufgaben-a1\_loes}
...
\makeatother
    ...
    \subsubsection{Lösung Aufgabe 1}\label{luxf6sung-aufgabe-1}

    \paragraph{Beispiele für
Verteilungen}\label{beispiele-fuxfcr-verteilungen}
